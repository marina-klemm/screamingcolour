...
colourGroups <- c(
  ...
  "plaid" = "colourful",     
  "rainbow" = "colourful",
  "screaming colour" = "colourful", 
  "stained glass" = "colourful",
...
dresscolourMapping <- unique(oneRowPerConcert %>% select(DressName, ColourHex1))
