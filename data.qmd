...
## Simple colour sentiment dataset

The [`album_info_metadata_neutral.xlsx`](https://github.com/cmjt/studyinswift/blob/cmjt/raw_data/album_info_metadata_neutral.xlsx) dataset...
